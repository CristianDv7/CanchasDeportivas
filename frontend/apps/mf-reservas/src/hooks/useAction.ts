// Mutaciones (POST/PATCH) — design.md §4. `run()` nunca throwea: así el
// `onSubmit` de la UI queda lineal (`if (creada === null) return;`) sin
// try/catch propio en la capa de componentes.
