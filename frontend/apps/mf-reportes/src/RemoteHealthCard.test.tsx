...
describe("RemoteHealthCard (mf-reportes)", () => {
  beforeEach(() => {
  ...
  it("muestra el nombre literal del remote y un build id", () => {
    ...
    expect(screen.getByTestId("remote-name")).toHaveTextContent("mf-reportes");
  ...
  it("muestra el origen federado, no el del shell", () => {
    ...
    expect(screen.getByTestId("remote-origin")).toHaveTextContent("localhost:3003");
  });
