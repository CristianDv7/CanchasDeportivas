// Fetching propio sin TanStack Query (design.md §4, ADR-02: copia de
// mf-reservas, comentario cruzado). Cada pantalla instancia su propio
// `useResource` — sin caché compartida.
