...
describe("RemoteHealthCard (mf-administracion)", () => {
  beforeEach(() => {
  ...
  it("muestra el nombre literal del remote y un build id", () => {
    ...
    expect(screen.getByTestId("remote-name")).toHaveTextContent("mf-administracion");
  ...
  it("muestra el origen federado, no el del shell", () => {
    ...
    expect(screen.getByTestId("remote-origin")).toHaveTextContent("localhost:3002");
  });
