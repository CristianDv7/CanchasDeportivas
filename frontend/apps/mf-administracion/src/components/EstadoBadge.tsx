...
// Compartido entre canchas y reservas (RN-08). No decide lógica de negocio
// propia: si `estadoBadge` cambia, este componente no necesita tocarse.
...
export function EstadoBadge({ estado }: EstadoBadgeProps) {
  ...
  return (
    <span data-testid="estado-badge" data-tone={tone} className="mfa-badge">
      {label}
    </span>
  );
}
